            ...
            <div class="flex-box">
                <div class="col-sm-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><?php echo ucwords($aProductSpecificDetails['product_type']); ?> Registration in <?php echo $aProductDetails['prod_name']; ?></li>
                    </ol>
                </div>
                <div class="col-sm-12">
    ...
    <form action="<?php echo admin_url('admin-ajax.php'); ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="input-container">
            ...
            <label class="custom-file-upload" style="margin-bottom:0px;">
                <input type="file" name="product_images[]" id="product_images" multiple onchange="previewImages(event)" required>
        ...
        <div class="container">
            <div class="row">
                <div class="flex-box">
                    <div class="col-md-7">
                        <div class="row">
                            <!-- Removed Design Type Section -->
                            <!-- Removed Design Text Section -->
                            <div class="top-form">
                                <div class="col-sm-12">
                                    <div class="input-container">
                                        ...
                                        <?php if($aProductDetails['prod_name'] == "USA"){ ?>
                                            <span class="small">If you are not using mark currently, please note you
                                            will be charged Government fee $100 at the time of filling statement of
                                            use.</span>
                                        <?php } ?>
                                    </div>
                                </div>
...
<section class="fxditms">
    ...
    <div class="ordrsmry  hidden-sm hidden-xs">
        ...
        <table class="table">
            ...
            <tr>
                <td>Package:</td>
                <td><?php echo $aProductDetails['name']; ?><br>$<?php echo $aProductDetails['price']; ?></td>
            </tr>
            <tr>
...
<script>
    function previewImages(event) {
        ...
        if (fileList.length > 5) {
            uploadError.textContent = "You can upload maximum 5 images.";
            return false;
        } else {
        ...
        for (var i = 0; i < fileList.length; i++) {
            ...
            if (!allowedExtensions.exec(file.name)) {
                uploadError.textContent = "Only .jpg, .jpeg, .png files are allowed.";
                return false;
            } else {
                uploadError.textContent = "";
            }
        ...
        uploadStatus.textContent = fileList.length + " file(s) selected.";
    }
</script>
