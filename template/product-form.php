...
<script type="text/javascript">
    var cart_state={};cart_state.product=JSON.parse('<?php echo json_encode($aProductSpecificDetails); ?>'),cart_state.total_price=parseInt(<?php echo $aProductDetails['price']; ?>),cart_state.selected_addons=[]
</script>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="input-container">
                                                    ...
                                                    <input type="text" name="<?php echo ucwords($aProductSpecificDetails['product_type']); ?>_text" placeholder="IPL Traders" class="form-control" id="txt"><span class="small">Type in all the words, letters or numbers included in your <?php echo ucwords($aProductSpecificDetails['product_type']); ?>.</span></div>
                                            </div>
                                                ...
                                                <div class="input-container">
                                                    ...
                                                    <div class="radio">
                                                        <label class="radio_input">Yes
                                                            <input type="radio" checked="checked" name="<?php echo ucwords($aProductSpecificDetails['product_type']); ?>_inuse" value="yes"><span class="checkmark"></span></label>
                                                    </div>
                                                    <div class="radio">
                                                        <label class="radio_input">No
                                                            <input type="radio" name="<?php echo ucwords($aProductSpecificDetails['product_type']); ?>_inuse" value="no"><span class="checkmark"></span></label>
                                                    </div>
                                                    <div class="dtpkr tdate">
                                                        <div class="wthicon">
                                                            <input class="form-control" id="date" name="<?php echo ucwords($aProductSpecificDetails['product_type']); ?>_date" placeholder="MM/DD/YYYY" type="text"><span class="bg-calendar_icon"></span></div>
                                                    </div>
                                                    <?php if($aProductDetails['prod_name'] == "USA"){ ?> <span class="small">If you are not using mark currently, please note you will be charged Government fee $100 at the time of filling statement of use.</span>
                                                        <?php } ?>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="input-container">
                                                    ...
                                                    <p class="para">Select the classes in which to register your
                                                        <?php echo ucwords($aProductSpecificDetails['product_type']); ?>, depending on which products or services the mark will be used for. Once you have selected the classes fill in the corresponding boxes with the description of products or services.</p><span class="small"><i>*Note:</i>Sample text about the price if he adds classes.</span></div>
                                                                            ...
                                                                            <?php $bIsFirst = $currentVal == 1;$currentVal++; ?>
                                                                                <div class="panel panel-default">
                                                                                    <div class="panel-heading" role="tab" id="heading<?php echo $aAddons['addon_id']; ?>">
                                                                                        <h4 class="panel-title"><label class="check_input"><a <?php echo !$bIsFirst ? 'class="collapsed"' : ""; ?> role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse<?php echo $aAddons['addon_id']; ?>" aria-expanded="<?php echo $bIsFirst ? 'true' : "false"; ?>" aria-controls="collapse<?php echo $aAddons['addon_id']; ?>"><?php echo strip_tags($aAddons['addon_name']); ?></a><input type="checkbox" class="addon-select" name="addon[]" value="<?php echo $aAddons['addon_id']; ?>"><span class="checkmark"></span></label></h4></div>
                                                                ...
                                                                <div class="panel-group" id="unassure1" role="tablist" aria-multiselectable="true">
                                                                    <div class="panel panel-default">
                                                                        <div class="panel-heading" role="tab" id="surity1">
                                                                            <h4 class="panel-title"><label class="check_input"><a role="button" data-toggle="collapse" data-parent="#unassure1" class="collapsed" href="#collapseSurity1" aria-expanded="true" aria-controls="collapseSurity1">I am unsure</a><input type="checkbox" name="unsure-<?php echo $sAddonGroup; ?>" class="unsure"><span class="checkmark"></span></label></h4></div>
                                                                        <div id="collapseSurity1" class="panel-collapse collapse" role="tabpanel" aria-labelledby="surity1">
                                                                            <div class="panel-body">Chemical Products; Chemicals used in industry, science and photography, as well as in agriculture, horticulture and forestry; unprocessed artificial resins; unprocessed plastics;
                                                                                manures; fire extinguishing compositions; tempering and soldering preparations; chemical substances for preserving foodstuffs; tanning substances; adhesives used in industry.</div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="input-container">
                                                                ...
                                                                <div class="wthicon">
                                                                    <input type="text" name="email" placeholder="Enter your email address" class="form-control" id="email"><span class="bg-email_icon"></span></div>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6">
                                                            <div class="input-container">
                                                                ...
                                                                <div class="wthicon">
                                                                    <input type="text" name="phone" placeholder="Enter your phone number" class="form-control" id="phone"><span class="bg-phone_icon"></span></div>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-12">
                                                            <div class="input-container">
                                                                ...
                                                                <div class="wthicon">
                                                                    <input type="text" name="name" placeholder="Enter your name" class="form-control" id="name"><span class="bg-name_icon"></span></div>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-12">
                                                            <div class="input-container">
                                                ...
                                                <div class="mob-left">
                                                    <div class="col-sm-12">
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <div class="input-container">
                                                                    <label for="count">Quantity<span class="small">(Int. Nice Classes)</span></label><span class="number-wrapper"><input type="number" disabled="disabled" class="form-control count" id="count" value="1" min="0"></span></div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="input-container">
                                                                    <label>Total</label><span class="amount">$<?php echo $aProductDetails['price']; ?></span></div>
                                                            </div>
                                                            <div class="col-sm-12">
...
<?php echo do_shortcode('[relatedproduct]'); ?>
    <section class="fxditms">
        <div class="callbtn hidden-sm hidden-xs">
            <a href="#"><img src="/wp-content/uploads/2021/09/call_btn.png" alt="img" class="img-resposive"></a>
        </div>
                ...
                <table class="table">
                    <tbody>
                        ...
                        <tr>
                            <td>Package:</td>
                            <td>
                                <?php echo $aProductDetails['name']; ?>
                                    <br>$
                                    <?php echo $aProductDetails['price']; ?>
                            </td>
                        </tr>
                        <tr>
                            <td>Additional Class:</td>
                            <td id="addon-summary">0 x $
                                <?php echo $aProductDetails['class_price']; ?>
                            </td>
                        </tr>
                        <tr>
                            <td>Total:</td>
