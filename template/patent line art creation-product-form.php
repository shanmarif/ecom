<?php
    ...
    if (!$isTrademarkForm) {
        ...
        $newProductTitle = "Trademark Registration in Patent Line Art Creation";
    }
?>
...
<section class="formsec sec" style="padding: 0;">
    <form id="productForm" action="<?php echo admin_url('admin-ajax.php'); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="top-form">
                                <div class="col-sm-6">
                                    <div class="input-container">
                                        ...
                                        <span class="small">Upload images of your product.</span>
...
<script>
    document.getElementById('product_images').addEventListener('change', function() {
        ...
        document.querySelector('.filename').innerText = filename.slice(0, -2);
    });
</script>
